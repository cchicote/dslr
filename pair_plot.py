...
def my_pair_plot(df, classes):
    graph = sns.pairplot(pd.DataFrame(df), hue="Hogwarts House", vars=classes, plot_kws={'alpha': 0.2}, diag_kind='hist', diag_kws={'alpha':0.6}, palette=describe.houses_colors)
    plt.show()
